...
>
> 2. 特别重要，它相当于的这个定位，在调整top和left的值的时候要注意。
>
>    > ​	**它定位不能超过父容器！！！，比如你div 300乘300，你父容器400*400，你不能top 120，这样下面会消失！！！**平时一般不会遇到这种情况，因为你大布局用div分割好了，小布局的absolute肯定不会跑太远，所以超不过relative的父容器，所以这点容易忽视。
